...
MySQL - 5.7.14 : Database - freshmanservice
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`freshmanservice` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `admin`(`adminname`,`password`,`id`) values ('admin1','64efcf27bcebe1e478b1da26bb97d646',1),('admin2','64efcf27bcebe1e478b1da26bb97d646',2),('adimn3','64efcf27bcebe1e478b1da26bb97d646',3);
...
CREATE TABLE `question` (
  ...
  `state` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0是未回答，1是已经回答',
  `answer` text,
  PRIMARY KEY (`id`)
